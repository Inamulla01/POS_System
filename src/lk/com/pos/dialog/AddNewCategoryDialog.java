 ...
 * @author moham
 */
public class AddNewCategoryDialog extends javax.swing.JDialog {
    ...
    private void setupArrowKeyNavigation() {
        ...
        category.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyPressed(java.awt.event.KeyEvent evt) {
                handleArrowNavigation(evt, category);
            }
        });
    ...
    private void addEnterKeyNavigation() {
        // Add key listener to category field - when Enter is pressed and field is not empty, go to save button
        category.addKeyListener(new java.awt.event.KeyAdapter() {
            @Override
            public void keyPressed(java.awt.event.KeyEvent evt) {
                if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
    ...
    private void setupTooltips() {
        category.setToolTipText("Type category name and press ENTER to move to buttons");
        saveBtn.setToolTipText("Click to save category (or press ENTER when focused)");
    ...
    private void initComponents() {
        ...
        category.setFont(new java.awt.Font("Nunito SemiBold", 0, 14)); // NOI18N
        category.setText("Colombo 8");
        category.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Category Name  *", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Nunito SemiBold", 0, 14))); // NOI18N
