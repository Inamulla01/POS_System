...
public class UpdateCheque extends javax.swing.JDialog {
    ...
    private void loadChequeData() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                System.out.println("Loaded cheque data for ID: " + chequeId + ", Amount: " + amount);
            } else {
    ...
    private void updateCheque() {
        ...
        System.out.println("updateCheque() called at: " + new Date());
    ...
    private void createChequeUpdateNotification(String customerName, String chequeNo, double amount, Date chequeDate, String bankName, String branch, Connection conn) {
        ...
        try {
            ...
            System.out.println("Cheque update notification created successfully for customer: " + customerName);

        } catch (Exception e) {
            e.printStackTrace();
            System.err.println("Failed to create cheque update notification: " + e.getMessage());
        } finally {
            try {
                if (pstMassage != null) {
                    pstMassage.close();
