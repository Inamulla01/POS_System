...
public class AddNewExpenseType extends javax.swing.JDialog {
    ...
    private void setupArrowKeyNavigation() {
        ...
        expenseType.addKeyListener(new java.awt.event.KeyAdapter() {
            @Override
            public void keyPressed(java.awt.event.KeyEvent evt) {
                handleArrowNavigation(evt, expenseType);
            }
        });
    ...
    private void handleRightArrow(java.awt.Component source) {
        if (source == expenseType) {
            ...
            expenseType.requestFocusInWindow();
        }
    }
    ...
    private void addEnterKeyNavigation() {
        // Add key listener to expenseType field - when Enter is pressed and field is not empty, go to save button
        expenseType.addKeyListener(new java.awt.event.KeyAdapter() {
            @Override
            public void keyPressed(java.awt.event.KeyEvent evt) {
                if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                    String expenseTypeName = expenseType.getText().trim();
    ...
    private void setupTooltips() {
        expenseType.setToolTipText("Type expense type name and press ENTER to move to buttons");
        saveBtn.setToolTipText("Click to save expense type (or press ENTER when focused)");
    ...
    private boolean isExpenseTypeExists(String expenseTypeName) {
        try {
            Connection conn = MySQL.getConnection();
            String sql = "SELECT COUNT(*) FROM expenses_type WHERE expenses_type = ?";
            PreparedStatement pst = conn.prepareStatement(sql);
            pst.setString(1, expenseTypeName);
    ...
    private void saveExpenseType() {
        ...
        if (isExpenseTypeExists(expenseTypeName)) {
            expenseType.requestFocus();
            return;
        }
    ...
    private void initComponents() {
        ...
        expenseType = new javax.swing.JTextField();
        ...
        expenseType.setFont(new java.awt.Font("Nunito SemiBold", 0, 14)); // NOI18N
        expenseType.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Expense Type  *", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Nunito SemiBold", 0, 14))); // NOI18N
    ...
    private void expenseTypeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_expenseTypeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_expenseTypeActionPerformed
    ...
    private javax.swing.JTextField expenseType;
