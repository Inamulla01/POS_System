...
public class NotificationPanel extends javax.swing.JPanel {
    ...
    private void initializeMessageTypeMappings() {
        ...
        messageTypeColors.put(1, new Color(255, 193, 7));
        messageTypeColors.put(2, new Color(244, 67, 54));
        messageTypeColors.put(3, new Color(76, 175, 80));
        messageTypeColors.put(4, new Color(33, 150, 243));
        messageTypeColors.put(5, new Color(211, 47, 47));
        messageTypeColors.put(7, new Color(156, 39, 176));
        messageTypeColors.put(8, new Color(0, 150, 136));
        messageTypeColors.put(9, new Color(67, 160, 71));
        messageTypeColors.put(10, new Color(66, 165, 245));
        messageTypeColors.put(11, new Color(171, 71, 188));
        messageTypeColors.put(12, new Color(102, 187, 106));
        messageTypeColors.put(13, new Color(41, 182, 246));
        messageTypeColors.put(14, new Color(255, 167, 38));
        messageTypeColors.put(16, new Color(205, 133, 63));
        messageTypeColors.put(17, new Color(186, 104, 200));
        messageTypeColors.put(18, new Color(240, 98, 146));
        messageTypeColors.put(19, new Color(38, 198, 218));
        messageTypeColors.put(20, new Color(210, 105, 30));
        messageTypeColors.put(21, new Color(102, 187, 106));
        messageTypeColors.put(22, new Color(126, 87, 194));
        messageTypeColors.put(23, new Color(0, 188, 212));
        messageTypeColors.put(24, new Color(229, 57, 53));
        messageTypeColors.put(25, new Color(244, 81, 30));
        messageTypeColors.put(26, new Color(94, 53, 177));
        ...
        iconSizes.put(1, 30);   // Expired Soon - slightly larger
        iconSizes.put(2, 26);   // Low Stock
        iconSizes.put(3, 26);   // Logged In
        iconSizes.put(4, 26);   // Log Out
        iconSizes.put(5, 28);   // Expired - larger for urgency
        ...
        iconSizes.put(13, 32);  // Complete Sale - larger for important action
        ...
        iconSizes.put(25, 32);  // Stock Loss - larger for important warning
